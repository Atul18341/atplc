...
import { Copy, Info, Award, FileText, Eye, EyeOff } from 'lucide-react';
import {
  WhatsappShareButton,
  WhatsappIcon,
  LinkedinShareButton,
    ...
    <section className="w-full min-h-screen bg-slate-50/50 p-6 md:p-10 space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200 p-4 rounded-xl shadow-sm">
          <h4 className="text-sm font-bold text-slate-700 uppercase tracking-wider">Course Tasks</h4>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button 
              ...
              className="group relative flex items-center justify-center p-2.5 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-full transition-colors"
            >
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-2 shadow-sm space-y-6 pt-4 border-t border-slate-100 flex flex-col items-center min-h-[150px] w-full gap-6">
        ...
        <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider">Course Certificate</h3>
      </div>
                ...
                {isEligible ? (
                  <div className="flex flex-col items-center gap-4 w-full">
                    ...
                    {/* Control Toolbar Action Switches */}
                    <div className="flex items-center justify-center gap-4">
                      <button
                        type="button"
                        onClick={() => {
                          setActivateCertGeneration(true);
                          setShowCertificatePreview(true); // Auto-reveals container if not open
                        }}
                    ...
                    {/* ✅ FULL-WIDTH PREVIEW WORKSPACE FRAME CONTAINER */}
                    {(showCertificatePreview || activateCertGeneration) && (
                      <div className="w-full text-left bg-slate-50 border border-slate-200/60 rounded-2xl p-4 md:p-6 mt-2 space-y-4 animate-fadeIn shadow-inner">
                        ...
                        {/* ✅ High-fidelity scrolling container mapping 100% layout depth width parameters */}
